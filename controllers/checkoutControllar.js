...
const { orderSendMail } = require('../utils/OrderMailTemplate');
    ...
    try {
        ...
        if (paymentMode === "Cash on Delivery") {
            ...
            const mailOptions = {
                ...
                html: orderSendMail(name, email, phone, address, city, state, pin, totalPrice, orderStatus, paymentMode, paymentStatus)
            };
